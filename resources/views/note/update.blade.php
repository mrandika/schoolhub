    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Perbarui Catatan</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <form action="{{ action('NoteController@update', $note->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="class" required>
                                            ...
                                            <option value="{{ $class->id }}" @if ($note->id_class == $class->id) selected @endif>{{ $class->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                    <input type="text" name="text" value="{{ $note->text }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-primary">Perbarui Catatan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
