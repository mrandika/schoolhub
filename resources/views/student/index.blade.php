...
<script>
  $(document).ready(function () {
    ...
    $('#deleteStudent_{{ $student->id_user }}').on('click', function () {
      ...
      swal({
          title: "Anda yakin?",
          text: "Setelah akun siswa ini dihapus, semua data yang terkait akan terhapus!",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        })
          ...
          if (confirm) {
            $.ajax({
              ...
              success: function (data) {
                ...
                swal("Sukses!", "Akun siswa telah dihapus.", "success");
              },
              error: function (data) {
                swal("Gagal!", "Akun siswa gagal dihapus.", "error");
              }
            });
          }
        });
