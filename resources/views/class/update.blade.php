...
@section('title')
Register Class &mdash; SchoolHUB
@endsection
...
<div class="main-content" style="min-height: 922px;">
    <section class="section">
        <div class="section-header">
            ...
            <h1>Perbarui Kelas</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="#">Kelas</a></div>
                <div class="breadcrumb-item">Perbarui Kelas</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ action('ClassController@update', $class->id) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <input name="_method" type="hidden" value="PATCH">
                        <div class="card">
                            <div class="card-header">
                                <h4>Masukan Data Kelas</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-primary">Perbarui Kelas</button>
                                    </div>
                                </div>
                            </div>
                        </div>
