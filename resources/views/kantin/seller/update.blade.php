...
<div class="main-content" style="min-height: 922px;">
    <section class="section">
        <div class="section-header">
            ...
            <h1>Perbarui Data Penjual</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="#">Penjual</a></div>
                <div class="breadcrumb-item">Perbarui Data Penjual</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <form action="{{ action('KantinSellerController@update', $user->id) }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div id="image-preview" class="image-preview"
                                            style="background-image: url({{ url('uploads/userImage/'.\App\User::select('image')->where('id', $user->id)->first()->image) }}); background-size: cover; background-position: center center;">
